...
namespace VIZCore3DPlus.NET.Canvas
{
    public partial class FrmMain : Form
    {
        ...
        {
            int count = vizcore3d.Drawing2D.View.GetCanvasCountBy2DView();
            int idx = vizcore3d.Drawing2D.View.GetSelectCanvasBy2DView();

            // Clear existing items
            cbCanvasIndex.Items.Clear();

            // Add items
            for (int i = 0; i < count; i++)
            {
                cbCanvasIndex.Items.Add(i.ToString());
            }

            // Select the item at index 'idx'
            if (idx >= 0 && idx < count)
            {
                cbCanvasIndex.SelectedIndex = idx;
            }
        }
        ...
        {
            int idx = vizcore3d.Drawing2D.View.GetSelectCanvasBy2DView();
            vizcore3d.Drawing2D.View.RemoveCanvasBy2DView(idx);
            setSelectedIndexCheckBox();
        }
        ...
        private void btnCanvasBackgoundReverse_Click(object sender, EventArgs e)
        {
            ...
            vizcore3d.Drawing2D.View.Set2DViewBackgroundReverse(!enable);
        }
