...
namespace VIZCore3DPlus.NET.Object
{
    public partial class FrmMain : Form
    {
        ...
        {
            //vizcore3d.Drawing2D.Object2D.OnDrawing2DChangeBracketTextBy2DViewEvent +=
        }
        #endregion
        ...
        private void btnSelectedModelRescale_Click(object sender, EventArgs e)
        {
            ...
            if (objectID <= 0)
            {
                MessageBox.Show("오브젝트를 선택해야 합니다.", "VIZCore3DPlus.NET", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
