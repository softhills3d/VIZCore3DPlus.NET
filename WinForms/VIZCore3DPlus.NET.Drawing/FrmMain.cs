...
namespace VIZCore3DPlus.NET.Drawing
{
    public partial class FrmMain : Form
    {
        ...
        {
            cbDrawingType.Items.Add("Point");
            cbDrawingType.Items.Add("Line");
            cbDrawingType.Items.Add("Polyline");
            cbDrawingType.Items.Add("Arc");
            cbDrawingType.Items.Add("Circle");
            cbDrawingType.Items.Add("Rectangle");
            cbDrawingType.Items.Add("Spline");
            cbDrawingType.Items.Add("CloudBox");
            cbDrawingType.Items.Add("Polyline Cloud");
            cbDrawingType.Items.Add("Text");
            cbDrawingType.Items.Add("Text Box");
            cbDrawingType.Items.Add("Bracker Text");
            cbDrawingType.Items.Add("surface Note");
        }

        private void btnCreate_Click(object sender, EventArgs e)
        {
            if (cbDrawingType.Text == "Point")
            {
                vizcore3d.Drawing2D.Object2D.Set2DViewCreateObjectWithPoint();

            }
            else if (cbDrawingType.Text == "Line")
            {
                vizcore3d.Drawing2D.Object2D.Set2DViewCreateObjectWithLine();

            }
            else if (cbDrawingType.Text == "Polyline")
            {
                vizcore3d.Drawing2D.Object2D.Set2DViewCreateObjectWithPolyline();

            }
            else if (cbDrawingType.Text == "Arc")
            {
                vizcore3d.Drawing2D.Object2D.Set2DViewCreateObjectWithArc();

            }
            else if (cbDrawingType.Text == "Circle")
            {
                vizcore3d.Drawing2D.Object2D.Set2DViewCreateObjectWithCircle();

            }
            else if (cbDrawingType.Text == "Rectangle")
            {
                vizcore3d.Drawing2D.Object2D.Set2DViewCreateObjectWithRectangle();

            }
            else if (cbDrawingType.Text == "Spline")
            {
                vizcore3d.Drawing2D.Object2D.Set2DViewCreateObjectWithSpline();

            }
            else if (cbDrawingType.Text == "CloudBox")
            {
                vizcore3d.Drawing2D.Object2D.Set2DViewCreateObjectWithCloudBox();

            }
            else if (cbDrawingType.Text == "Polyline Cloud")
            {
                vizcore3d.Drawing2D.Object2D.Set2DViewCreateObjectWithPolyCloud();

            }
            else if (cbDrawingType.Text == "Text")
            {
                TextDialog dlg = new TextDialog();
                dlg.vizcore3d = vizcore3d;
                dlg.ShowDialog();

                if (dlg.DialogResult == DialogResult.OK)
                {
                    vizcore3d.Drawing2D.Object2D.Set2DViewCreateWithText(dlg.NoteText);
                }
            }
            else if (cbDrawingType.Text == "Text Box")
            {
                TextDialog dlg = new TextDialog();
                dlg.vizcore3d = vizcore3d;
                dlg.ShowDialog();
                ...
                if (dlg.DialogResult == DialogResult.OK)
                {
                    vizcore3d.Drawing2D.Object2D.Set2DViewCreateWithTextBox(dlg.NoteText);
                }
            }
            else if (cbDrawingType.Text == "Bracker Text")
            {
                vizcore3d.Drawing2D.Object2D.Set2DViewCreateWithBracketText();

            }
            else if (cbDrawingType.Text == "surface Note")
            {
                TextDialog dlg = new TextDialog();
                dlg.vizcore3d = vizcore3d;
                dlg.ShowDialog();
                ...
                if (dlg.DialogResult == DialogResult.OK)
                {
                    vizcore3d.Drawing2D.Object2D.Set2DViewCreateWithSurfaceNote(dlg.NoteText);
                }
            }
            else
            {
        ...
        /// <param name="sender">Sender</param>
        /// <param name="e">Event Args</param>
        private void btnDeleteAllObject_Click(object sender, EventArgs e)
        {
            vizcore3d.Drawing2D.Object2D.DeleteAllObjectBy2DView();
        }
        ...
        /// <param name="sender">Sender</param>
        /// <param name="e">Event Args</param>
        private void btnDeleteAllNonObject_Click(object sender, EventArgs e)
        {
            vizcore3d.Drawing2D.Object2D.DeleteAllNonObjectBy2DView();
        }
        ...
        /// <param name="sender">Sender</param>
        /// <param name="e">Event Args</param>
        private void btnDeleteSelectedObject_Click(object sender, EventArgs e)
        {
            vizcore3d.Drawing2D.Object2D.DeleteSelectedObjectBy2DView();
        }
        ...
        /// <param name="sender">Sender</param>
        /// <param name="e">Event Args</param>
        private void btnDeleteObjectWithSelectObject_Click(object sender, EventArgs e)
        {
            vizcore3d.Drawing2D.Object2D.Delete2DViewMeasureObjectWithSelect3DObj();
        }
        ...
        {
            vizcore3d.Drawing2D.Object2D.ShowAllObjectBy2DView();
        }
        ...
        {
            vizcore3d.Drawing2D.Object2D.HideAllObjectBy2DView();
        }
        ...
        private void btnShowSelected_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < list.Count; i++)
            {
                ...
                {
                    vizcore3d.Drawing2D.Object2D.ShowObjectBy2DView(list[i].ID, true);
                }
            }
        }
        ...
        private void btnHideSelected_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < list.Count; i++)
            {
                if (list[i].Select == true)
                {
                    vizcore3d.Drawing2D.Object2D.ShowObjectBy2DView(list[i].ID, false);
                }
            }
        }
        #endregion
        ...
        {
            LineThicknessDialog dlg = new LineThicknessDialog(vizcore3d);
            if (dlg.ShowDialog() != DialogResult.OK) return;
        ...
        {
            TextSizeDialog dlg = new TextSizeDialog(vizcore3d);
            if (dlg.ShowDialog() != DialogResult.OK) return;
        ...
        {
            TextBoxLineThicknessDialog dlg = new TextBoxLineThicknessDialog(vizcore3d);
            if (dlg.ShowDialog() != DialogResult.OK) return;
