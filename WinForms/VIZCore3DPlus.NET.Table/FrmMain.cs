...
namespace VIZCore3DPlus.NET.Table
{
    public partial class FrmMain : Form
    {
        ...
        #region Table
        private void btnAddVerticalPoint_Click(object sender, EventArgs e)
        {
            // 계측점 설정 : 수직도
            vizcore3d.Drawing2D.Measure.SetLevelMeasurePointOption(0, false, true, false, false, false, false, false);
        ...
        {
            int cellNum = Convert.ToInt32(txtCell.Text);
            int rowNum = Convert.ToInt32(txtRow.Text);
            int columnNum = Convert.ToInt32(txtColumn.Text);

            vizcore3d.Drawing2D.Object2D.Set2DViewCreateWithVerticalTable(cellNum, rowNum, columnNum, false, 0);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void btnStepMeasure_Click(object sender, EventArgs e)
        {
            int abacusNum = Convert.ToInt32(txtAbacus.Text);
            int insideNum = Convert.ToInt32(txtInside.Text);

            vizcore3d.Drawing2D.Object2D.Set2DViewCreateWithStepMeasureTable(abacusNum, insideNum);

            vizcore3d.Drawing2D.Render();
        }

        /// <summary>
        /// 2D 뷰 화면 개체(Tolerance 표) 생성
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void btnTolerance_Click(object sender, EventArgs e)
        {
            int levelNum = Convert.ToInt32(txtLevel.Text);
            int demensionNum = Convert.ToInt32(txtDimension.Text);
            int verticalityNum = Convert.ToInt32(txtVerticality.Text);

            vizcore3d.Drawing2D.Object2D.Set2DViewCreateWithToleranceTable(levelNum, demensionNum, verticalityNum);
