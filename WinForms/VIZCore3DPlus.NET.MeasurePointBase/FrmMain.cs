...
namespace VIZCore3DPlus.NET.MeasurePointBase
{
    public partial class FrmMain : Form
    {
        ...
        #region Base Point
        /// <summary>
        /// Drawing2D : 점 위치 기준 설정
        /// </summary>
        /// <param name="sender">Sender</param>
        /// <param name="e">Event Args</param>
        private void btnBaseInputSetting_Click(object sender, EventArgs e)
        {
            Vertex3D pos = vizcore3d.Drawing2D.Measure.Get2DViewSelectObjMeasurePointByBasePosition();

            if (pos == null) return;

            PointBaseSettingDialog dlg = new PointBaseSettingDialog();
            ...
            vizcore3d.Drawing2D.Measure.Set2DViewSelectObjMeasurePointByBasePosition(dlg.xPos, dlg.yPos, dlg.zPos);
        }

        /// <summary>
        /// Drawing2D : 점 위치 기준 선택
        /// </summary>
        /// <param name="sender">Sender</param>
        /// <param name="e">Event Args</param>
        private void btnBaseSelectSetting_Click(object sender, EventArgs e)
        {
            vizcore3d.Drawing2D.Measure.Set2DViewSelectWithMeasurePointBasePosition();
        }

        /// <summary>
        /// Drawing2D : 점 위치 기준 해제
        /// </summary>
        /// <param name="sender">Sender</param>
        /// <param name="e">Event Args</param>
        private void btnBaseCancle_Click(object sender, EventArgs e)
        {
            vizcore3d.Drawing2D.Measure.Release2DViewSelectModelWithMeasurePointBasePosition();
        }
        #endregion

        #region CP
        private void SetCPComboBoxItems()
        {
            cbCreateCP.Items.Add("CP0");
            cbCreateCP.Items.Add("CP1");
            cbCreateCP.Items.Add("CP2");
        }
        ...
        {
            if (cbCreateCP.Text == "CP0")
            {
                vizcore3d.Drawing2D.Object2D.Set2DViewCreateObjectWithCP0();

            }
            else if (cbCreateCP.Text == "CP1")
            {
                vizcore3d.Drawing2D.Object2D.Set2DViewCreateObjectWithCP1();

            }
            else if (cbCreateCP.Text == "CP2")
            {

                vizcore3d.Drawing2D.Object2D.Set2DViewCreateObjectWithCP2();
            }
            else
            {
                vizcore3d.Drawing2D.Object2D.Set2DViewCreateObjectWithCP0();
