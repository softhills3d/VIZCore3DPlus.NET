...
namespace VIZCore3DPlus.NET.Level
{
    public partial class FrmMain : Form
    {
        ...
        {
            vizcore3d.Drawing2D.Object2D.Set2DViewCreateObjectWithShipAxis();
        }
        ...
        {
            vizcore3d.Drawing2D.Object2D.Set2DViewCreateObjectWithHeightRoundMeasurePoint();
        }
        #endregion

        #region Level
        /// <summary>
        /// Drawing2D : 레벨 (Level) 기준설정
        /// </summary>
        /// <param name="sender">Sender</param>
        /// <param name="e">Event Args</param>
        private void btnSetLevelBase_Click(object sender, EventArgs e)
        {
            if (vizcore3d.Drawing2D.Measure.selectBaseLevelOption.Visible)
            {
                //이미 열려있음
                vizcore3d.Drawing2D.Measure.selectBaseLevelOption.BringToFront();
                vizcore3d.Drawing2D.Measure.selectBaseLevelOption.Focus();
            }
            else
            {
                vizcore3d.Drawing2D.Measure.selectBaseLevelOption.UpdateData();
                vizcore3d.Drawing2D.Measure.selectBaseLevelOption.Show();
                vizcore3d.Drawing2D.Measure.selectBaseLevelOption.Focus();
            }
        }

        /// <summary>
        /// Drawing2D : 레벨 (Level) 오차 생성
        /// </summary>
        /// <param name="sender">Sender</param>
        /// <param name="e">Event Args</param>
        private void btnAddLevelOffset_Click(object sender, EventArgs e)
        {
            vizcore3d.Drawing2D.Measure.Set2DViewCreateWithSelectMeasureLevelPointBasePosition();
        }
